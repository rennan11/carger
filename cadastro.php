...
?>
    ...
    <div class="container card-fixed">
        <div class="card-body">
            <h3 class="card-title title">Olá, <?php if(isset($_GET['nome'])) echo $_GET['nome']; else echo "Empresa" ?>. Termine seu cadastro abaixo:</h3>
            <form class="card-text form-group" method="get" action="painel.php">
                <input type="text" class="form-control" name="nome" value="<?php echo $_GET['nome'] ?>" required disabled><br>
                <input type="text" class="form-control" name="usuario" value="<?php echo $_GET['usuario'] ?>" required disabled><br>
                <input type="email" class="form-control" name="email" value="<?php echo $_GET['email'] ?>" required disabled><br>
                <input type="password" class="form-control" name="senha" value="<?php echo $_GET['senha'] ?>" required disabled><br>
                <input type="text" class="form-control" name="cnpj" placeholder="CNPJ" required><br>
                <input type="text" class="form-control" name="endereco" placeholder="Endereço" required><br>
                <input type="text" class="form-control" name="cep" placeholder="CEP" required><br>
